...
<!-- <div class="row-fluid">
	<div class="span12">
        <div class="thumbnail response" id="response-table">
            <h2>Vos tarifs</h2>
    		<div class="caption">
	...
	<div class="span5">
		...
		<div class="thumbnail hidden-phone">
			...
			<div class="caption">
				...
				<p class="muted">Vous êtes-vous penché sur la question de l’assurance de votre boule de poils ? Non, pas encore ? Voici quelques éléments de réponse&hellip;
				</p>
			</div>
		</div>
	</div>
